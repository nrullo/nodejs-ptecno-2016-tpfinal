...
angular
  ...
  .config(function ($routeProvider, $locationProvider, RestangularProvider, hotkeysProvider, toastrConfig) {
    ...
    $routeProvider
      ...
      .when('/crud/employee', {
        templateUrl: '/scripts/admin/views/employee.html',
        controller: 'EmployeeCtrl'
      })
      .when('/crud/employee-new', {
        templateUrl: '/forms/employee/create',
        controller: 'EmployeeNewCtrl'
      })
      .when('/crud/employee-edit/:id', {
        templateUrl: '/forms/employee/create',
        controller: 'EmployeeEditCtrl',
        resolve: {
          employee: function(Restangular, $route){
            return Restangular.one('employees', $route.current.params.id).get();
          }
        }
      })
      .otherwise({
